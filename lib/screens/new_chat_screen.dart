...
class _NewChatScreenState extends State<NewChatScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<UserModel>>(
        stream: _contactService.getRegisteredUsersStream(),
        builder: (context, snapshot) {
          ...
          // Headers
          listItems.add(_buildFixedOption(Icons.group, 'New group'));
          listItems.add(_buildFixedOption(Icons.person_add, 'New contact', trailing: const Icon(Icons.qr_code)));
  ...
  Widget _buildWebList(List<UserModel> users) {
     ...
     return ListView(
       children: [
          _buildFixedOption(Icons.group, 'New group'),
          _buildFixedOption(Icons.person_add, 'New contact', trailing: const Icon(Icons.qr_code)),
           const Padding(
            padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
  ...
  Widget _buildFixedOption(IconData icon, String label, {Widget? trailing}) {
    return ListTile(
